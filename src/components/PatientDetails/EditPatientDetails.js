    ...
    <div>
        ...
        <form autoComplete='off' style={{position:"absolute", top:"25%", left:"35%"}}>
           <label>Patient Id :   </label>
            ...
            <button type='button' style={{height:'30px', width:'80px', backgroundColor:'orangered',borderRadius:'15px',border:'none', textDecoration:"none"}}  ><Link to="/PatientDoctorDetails" >Back</Link></button>  {'\u00A0'} {'\u00A0'} {'\u00A0'}{'\u00A0'}{'\u00A0'}
            {'\u00A0'} {'\u00A0'} {'\u00A0'}{'\u00A0'}{'\u00A0'}
